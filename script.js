...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    alert(`Thank you, ${name}! Your consultation request has been received. We will contact you within 24 hours to schedule your free consultation.`);
...
document.addEventListener('DOMContentLoaded', function() {
    const elementsToAnimate = document.querySelectorAll('.service-card, .attorney-card, .about-text, .contact-info');
